                    ...
                    </div>
                    {
                       loading ?   (
                              ...
                              posts_search.map((post_search) => ( 
                                    <Card style={{ width: '15rem', display: "flex",alignItems: "center",  backgroundImage: 'linear-gradient(126.6deg, rgba(0, 0, 255, 0.12) 28.69%, rgba(0, 0, 255, 0) 100%)' , backdropFilter:'blur(140px)' }}>
