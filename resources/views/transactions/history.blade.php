    ...
    <div class="container">
        ...
        ============================================= -->
            <div class="col-lg-9">
                ...
                <h2 class="font-weight-400 mb-3">交易信息</h2>

                <div class="bg-light shadow-sm rounded py-4 mb-4">
                    <h3 class="text-5 font-weight-400 d-flex align-items-center px-4 mb-3">所有交易信息</h3>
                    <!-- Title
            =============================== -->
                    <div class="transaction-title py-2 px-4">
                        <div class="row">
                            <div class="col-2 col-sm-1 text-center"><span class="">日期</span></div>
                            <div class="col col-sm-7">描述信息</div>
                            <div class="col-auto col-sm-2 d-none d-sm-block text-center">状态</div>
                            <div class="col-3 col-sm-2 text-right">金额</div>
                        </div>
                    </div>
                    <!-- Title End -->
                        ...
                        <div class="transaction-item px-4 py-3">
                            <div class="row align-items-center flex-row">
                                ...
                                <div class="col-3 col-sm-2 text-right text-4"> <span class="text-nowrap">
                                    ...
                                    <span class="text-2 text-uppercase">(CHN)</span> </div>
                            </div>
                        </div>
                        @endforeach
                        <!-- View all Link
