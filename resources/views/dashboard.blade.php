        ...
        ============================================= -->
          ...
          =============================== -->
                <div class="bg-light shadow-sm rounded p-4 mb-4">
                    <h3 class="text-5 font-weight-400 d-flex align-items-center mb-3">简介信息完成度<span
                    ...
                    <div class="row profile-completeness">
                        ...
                        <div class="col-sm-6 col-md-3 mb-4 mb-sm-0">
                            <div class="border rounded p-3 text-center"> <span
                                ...
                                <p class="mb-0"><a class="btn-link stretched-link" href="">添加银行卡</a></p>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <div class="border rounded p-3 text-center"> <span
                                    ...
                                    class="text-5 d-block text-light mt-4 mb-3"><i class="far fa-circle "></i></span>
                                <p class="mb-0"><a class="btn-link stretched-link" href="">添加银行账户</a></p>
                            </div>
                        </div>
                    </div>
                </div>
          ...
          =============================== -->
                <div class="bg-light shadow-sm rounded py-4 mb-4">
                    <h3 class="text-5 font-weight-400 d-flex align-items-center px-4 mb-3">近期交易记录</h3>

                    <!-- Title
            =============================== -->
                    <div class="transaction-title py-2 px-4">
                        <div class="row">
                            <div class="col-2 col-sm-1 text-center"><span class="">日期</span></div>
                            <div class="col-2 col-sm-1">类型</div>
                            <div class="col col-sm-6">描述信息</div>
                            <div class="col-auto col-sm-1 d-none d-sm-block text-center">状态</div>
                            <div class="col-3 col-sm-2 text-right">总额</div>
                        </div>
                    </div>
                    <!-- Title End -->
...
¥:{{ $transaction->amount }}</span>
                                    <span class="text-2 text-uppercase">(RMB)</span> </div>
                            </div>
                        </div>
                        @endforeach
                        <!-- View all Link
            =============================== -->
                        <div class="text-center mt-4"><a href="{{ url('/transactions') }}" class="btn-link text-3">查看全部<i class="fas fa-chevron-right text-2 ml-2"></i></a></div>
                        <!-- View all Link End -->
